...
![/uploads/number-theory-set-1.png](/uploads/number-theory-set-1.png)
...
![/uploads/number-theory-set-2.png](/uploads/number-theory-set-2.png)
...
![/uploads/number-theory-set-3.png](/uploads/number-theory-set-3.png)
...
![/uploads/number-theory-set-intersection.png](/uploads/number-theory-set-intersection.png)
...
![/uploads/number-theory-set-diff-1.png](/uploads/number-theory-set-diff-1.png)

Hiệu của hai tập hợp $A$ và $B$.

![/uploads/number-theory-set-diff-2.png](/uploads/number-theory-set-diff-2.png)
